        ...
        for dataset_name in ['CIFAR_RGB','GTSRB_RGB']:       
            for model_name in ['RF','GB','pytorch']:
                ...
                for shuffle in range(1):
                    ...
                    np.save(f'./stab/{dataset_name}/stab_{reduced_method}_{red_param}_{dataset_name}_{model_name}_{shuffle}.npy',stability)
                    np.save(f'./stab/{dataset_name}/test_stab_{reduced_method}_{red_param}_{dataset_name}_{model_name}_{shuffle}.npy',stability_test)
